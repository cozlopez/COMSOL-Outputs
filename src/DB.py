...
import os
from SPL_directivity_arc import SPL_directivity_input_data
...
def Soundlevelplots2(data, selectedfrequency, Heightdipole, frequencysweep = False):
    ...
    if frequencysweep == True:
        ...
        for j in range (len(frequencies)):
            ...
            pressure_col = f'acpr3.p_t (Pa) @ freq={frequencies[j]}'
            pressureoutput = []
...
if __name__ == "__main__":
    ...
    data = SPL_directivity_input_data("Untitled2.txt", 8500, sweep=True)  # Replace with actual data loading
    selectedfrequency = 8500
    Heightdipole = "example_height"
    frequencysweep = False  # Set to True for frequency sweep
    Soundlevelplots2(data, selectedfrequency, Heightdipole, frequencysweep=True)