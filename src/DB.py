...
def Acoustic_pressure_plot(OUTPUTname):
    ...
    data = np.loadtxt(lines, dtype=complex, comments='%')
    ...
    plt.grid(False)
    plt.savefig("OUTPUTS/"+OUTPUTname, dpi=1000, bbox_inches='tight')
    plt.show()
...
if __name__ == "__main__":
    Acoustic_pressure_plot(OUTPUTname="Test_Acoustic_pressure.png")
